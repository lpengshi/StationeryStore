...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:StoreConnectionString %>" SelectCommand="OrderTrendAnalysis" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
        <br /><br />
    </form>
</body>
